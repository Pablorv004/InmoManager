...
public class GUIUserView extends JFrame {
	...
	public GUIUserView(JFrame frame) {
		...
		lblPrice.setFont(fontPropertyNumbers);
		...
		lblPriceTag.setFont(fontPropertyNumbers);
		panelPrice.add(lblPriceTag);
		
		separator_3 = new JSeparator();
		separator_3.setOrientation(SwingConstants.VERTICAL);
		contentPane.add(separator_3, BorderLayout.WEST);
