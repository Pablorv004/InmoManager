...
public class Purchasable_Property extends Property {
	...
	public Purchasable_Property(String address, String city, String type, int age, int rooms, int floors,
		...
		super(address, city, type, age, rooms, floors, bathrooms, propertySize, terrainSize, garageSize, hasGarden,
